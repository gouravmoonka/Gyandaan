      ...
      >
        {user.name && (
          <ul className="navbar-nav  ml-auto">
            ...
            <li className="nav-item">
              <a className="logout" href="/studentLogin" onClick={logOut}>
                Sign out
              </a>
            </li>
          </ul>
        ...
        {!user.name ? (
          <ul className="navbar-nav  ml-auto">
            ...
            <li className="nav-item">
              <a className="nav-link" href="/StudentSignup">
                Student Signup
              </a>
            </li>
            <li className="nav-item active">
              <a className="nav-link" href="/MentorLogin">
                Mentor Login
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="/MentorSignup">
                Mentor Signup
              </a>
            </li>
          </ul>
      ...
      {user.name && pathname !== "messenger" ? (
        <div className="navbar">
          ...
          <div className="icons">
            <div
              className="icon"
              onClick={() => notifications.length > 0 && setOpen(!open)}
            >
